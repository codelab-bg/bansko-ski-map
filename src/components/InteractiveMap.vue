<template>
  <div>
    <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 704.5 917">
      <!-- Църна могила -->
      <g class="g-1" @click="showInfoModal(1)">
        <g>
      ...
      <!-- Чилин Валог 1 -->
      <g class="g-2" @click="showInfoModal(2)">
        <g>
      ...
      <!-- Шилигарник 2 -->
      <g class="g-3" @click="showInfoModal(3)">
        <g>
      ...
      <!-- Моста -->
      <g class="g-4" @click="showInfoModal(4)">
        <g>
      ...
      <!-- Бъндеришка Поляна -->
      <g class="g-5" @click="showInfoModal(5)">
        <g>
      ...
      <!-- Плато 1 -->
      <g class="g-6" @click="showInfoModal(6)">
        <g>
      ...
      <!-- Чалин -->
      <g class="g-7" @click="showInfoModal(7)">
        <g>
      ...
      <!-- Стражите -->
      <g class="g-8" @click="showInfoModal(8)">
        <g>
          <g>
        ...
        <g>
          <path class="st0" d="M210.2 521.3c0-25.6-2-36.1-4.2-40.6-1-2.1-2.3-4-3.9-5.7-3-3.2-6.9-8.2-10.6-13.2"/>
          <g>
            <g>
              <circle class="st1" cx="209.2" cy="488.5" r="6.6"/>
            </g>
          </g>
          <g>
            <g>
          ...
          <circle class="st1" cx="210.4" cy="520.8" r="2.3"/>
        </g>
      </g>
    </svg>
    <!-- info modal -->
